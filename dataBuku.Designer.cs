namespace projekPPK2019
{
	partial class dataBuku
	{
		...
		private void InitializeComponent()
		{
			...
			this.label6.Text = "Tambah Data Buku";
			// 
			// label5
			// 
			...
			this.label5.Text = "Masukkan judul:";
			// 
			// button3
			// 
			this.button3.Location = new System.Drawing.Point(667, 394);
			...
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(642, 63);
			...
			// textBox4
			// 
			this.textBox4.Location = new System.Drawing.Point(163, 233);
